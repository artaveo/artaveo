...
M1 — CREDIBLE LAUNCH (own domain, real content, no fake backend)
  ...
  Phase 9   Start a Project (Inquiry v1)     Multi-step brief form + first real backend (saves leads, sends e-mail)    ⏳ PARTIAL (9.1 Brief Builder ✅ at /start; 9.2 persistence ✅ live & verified; 9.3 notifications not started — see docs/phases/PHASE-9.1-README.md, docs/phases/PHASE-9.2-README.md)
...
## Phase 9 — Start a Project (Inquiry v1 — first real backend slice)  ⏳ PARTIAL (9.1 ✅ complete — see `docs/phases/PHASE-9.1-README.md`; 9.2 ✅ complete — live and verified end-to-end, see `docs/phases/PHASE-9.2-README.md`; 9.3 not started, blocked on D-01)
