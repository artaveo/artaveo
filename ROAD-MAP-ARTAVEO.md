...
M1 — CREDIBLE LAUNCH (own domain, real content, no fake backend)
  ...
  Phase 10  Installable PWA & Offline Shell  Site installs like an app, browsable offline; Brief Builder never fakes success offline    ⏳ PARTIAL (10.1 manifest/install/update ✅, 10.2 caching strategy ✅ — see docs/phases/PHASE-10.1-README.md, PHASE-10.2-README.md; 10.3 offline Brief Builder behaviour not started)
...
## Phase 10 — Installable PWA & Offline-Safe Shell  ⏳ PARTIAL (10.1 ✅ complete — see `docs/phases/PHASE-10.1-README.md`; 10.2 ✅ complete — see `docs/phases/PHASE-10.2-README.md`; 10.3 offline Brief Builder behaviour not yet started)
