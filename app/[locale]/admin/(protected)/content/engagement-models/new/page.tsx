...
export async function generateMetadata({
  ...
  return { title: t('cmsNewEngagementModel'), robots: { index: false, follow: false } }
}
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6">
      <div>
        ...
        <h1 className="mt-1 text-xl font-semibold tracking-tight">{t('cmsNewEngagementModel')}</h1>
      </div>
      <EngagementModelForm mode="create" />
    </div>
  )
}
