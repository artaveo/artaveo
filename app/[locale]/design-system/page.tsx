...
/**
 * Internal, `noindex` tooling page (roadmap § 4.7) — not part of the
 * bilingual public-site content scope. Only the metadata is translated
 * here; the showcase content itself stays in English, same as before
 * Phase 5.1.
 */
